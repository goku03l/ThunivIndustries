  ...
  builds: [
    {
      ...
      story:    "Just wanted to try things out of my curiosity.,Engineers waste thousands of hours clicking through CAD tools to model ideas they already have in their heads. I fixed that. IntelliCAD lets you describe a 3D geometry in plain language and get a production-ready CAD file — no manual sketches, no constraint dragging. You talk to it like a peer, it ships the geometry. The interface CAD software should have built a decade ago.",
      company:  "Personal",
    ...
    },
    {
      ...
      story:    "A freelance project for a Political Party. Turned unstructured social media noise into dashboards business teams open every morning. Owned the full arc — PRD, KPIs, UAT, post-launch adoption.",
      company:  "Freelance",

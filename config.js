...
const CONFIG = {
  ...
  ───────────────────────────────────────────────────────── */
  skills: [
      { category: "AI & LLMs",      items: ["Prompt Engineering", "LLM Systems", "OpenAI APIs", "RAG"] },
      { category: "ML & NLP",       items: ["Scikit-learn", "Sentiment Analysis", "Classification", "Python","Tensorflow"] },
      { category: "Product",        items: ["PRD Writing", "Sprint Planning", "UAT", "KPI Definition","Vendor Handling"] },
      { category: "Soft Skills",    items: ["0→1 Execution", "Stakeholder Mgmt", "Cross-functional", "Founder Mindset"] },
    ],
  layout: {
